      ...
      <div class="row">
        ...
        <div class="shadow-effect">
          <div class="row">
            ...
            <div class="col-sm-12 col-md-9">
              <h4>Email Us</h4>
				<p><a href="mailto:info@subhlakshmi.in">info@subhlakshmi.in</a></p></br></br>
            </div>
          </div>
          </div>
        </div>
        ...
        <div class="col-sm-4">
         <div class="shadow-effect">
          <div class="row">
            <div class="col-sm-12 col-md-3">
              <div class="number blue"><span class="typcn typcn-phone-outline"></span> </div>
            </div>
            <div class="col-sm-12 col-md-9">
              <h4>Call Us </h4>
				<p> +91 83778 08085 </br> 0124-4233318</p></br>
<!--              <span><a href="#">info@visscous.com</a></span>
-->            </div>
          </div>
          </div>
        </div>
