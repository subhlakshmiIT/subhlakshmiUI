          ...
          <div class="row no-gutter">
            ...
            <div class="col-sm-3">
              <div class="footer-element">
                ...
                <p>Floor 2, 200, Plot No. 23

<span>Shivaji Marg, Moti Nagar, Delhi-110015
</span></p>
              </div>
            </div>
            <!-- FOOTER TOP ELEMENT -->
      ...
      breakpoints: {
        ...
        500: {
          ...
          $('.odometer').waypoint(function() {
            ...
            setTimeout(function() {
              $('#odometer2.odometer').html(15);
            }, 1000);

            setTimeout(function() {
              $('#odometer3.odometer').html(25);
            }, 1500);

            setTimeout(function() {
              $('#odometer4.odometer').html(24335);
            }, 2000);
            setTimeout(function() {
              $('#odometer5.odometer').html(67.21);
            }, 2000);
