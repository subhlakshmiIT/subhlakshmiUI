<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="LatestNews.aspx.cs" Inherits="Admin_LatestNews" %>
        ...
        <asp:GridView ID="GrdUserImage" runat="server" AutoGenerateColumns="False" CssClass="table  table-bordered table-hover">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Heading">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="Labell4" runat="server" Text='<%# Bind("Heading") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
