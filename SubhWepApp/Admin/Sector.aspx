<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Sector.aspx.cs" Inherits="Admin_Sector" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="row">
							<div class="col-xs-12">
                                ...
                                ControlToValidate="txtDescription" ErrorMessage="Required"  ValidationGroup="Desc"
                                ForeColor="Red"></asp:RequiredFieldValidator>
									...
									<div>
										<div class="col-md-offset-3 col-md-9">
                                            ...
                                            <asp:Button ID="btnLogin" class="btn btn-info" runat="server" ValidationGroup="Desc" Text="Submit" OnClick="btnLogin_Click"></asp:Button>
        ...
        <asp:GridView ID="GrdUserImage" runat="server" AutoGenerateColumns="False" CssClass="table  table-bordered table-hover">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Loan Name">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="Labell" runat="server" Text='<%# Bind("FooterTitle") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
