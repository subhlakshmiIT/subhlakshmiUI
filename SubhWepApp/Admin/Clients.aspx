...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="row">
                ...
                <asp:FileUpload ID="FileUpload1" runat="server" class="btn btn-white btn-inverse btn-sm" />
                                ...
                                <div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Designation And Organization</label>
        ...
        <asp:GridView ID="GrdUserImage" runat="server" AutoGenerateColumns="False" CssClass="table  table-bordered table-hover">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Name">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="Labell" runat="server" Text='<%# Bind("Name") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Designation & Organization">

                                                <ItemTemplate>
                                                    <asp:Label ID="Labell4" runat="server" Text='<%# Bind("Desig_Org") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
