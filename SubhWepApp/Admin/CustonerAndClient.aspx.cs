...
public partial class Admin_CustonerAndClient : System.Web.UI.Page
{
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string st = "delete [Customer] where Id=@Id";
    ...
    protected void btnSelect_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            LinkButton lnkRemove = (LinkButton)sender;
            Id = int.Parse(lnkRemove.CommandArgument);
            string st = "select * from [Customer] where Id=@Id";
    ...
    protected void btnPicSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Id == 0)
            {
                ...
                st = "insert into [Customer]([CustomerImage],[Heading],[Description])values(@CustomerImage,@Heading,@Description)";
            ...
            {
                st = "Update [Customer] set [CustomerImage]=@CustomerImage,[Heading]=@Heading,[Description]=@Description where Id=@Id";
